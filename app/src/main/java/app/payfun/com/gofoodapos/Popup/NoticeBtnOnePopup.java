...
public class NoticeBtnOnePopup extends Dialog implements View.OnClickListener {
	...
	public NoticeBtnOnePopup(Context context, String body2, OnEventOkListener onEventPopupListener) {
...
//		requestWindowFeature(Window.FEATURE_NO_TITLE);
		setContentView(R.layout.notice_btn_one_popup);
