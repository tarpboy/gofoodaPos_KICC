...
public class TestPopup extends Dialog implements View.OnClickListener {
	...
	public TestPopup(Context context, String body2, OnEventOkListener onEventPopupListener) {
