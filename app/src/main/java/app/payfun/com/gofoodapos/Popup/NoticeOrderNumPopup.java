...
public class NoticeOrderNumPopup extends Dialog implements View.OnClickListener {
	...
	public NoticeOrderNumPopup(Context context, String body2, OnEventOkListener onEventPopupListener) {
...
//		requestWindowFeature(Window.FEATURE_NO_TITLE);
		setContentView(R.layout.notice_order_num_popup);
