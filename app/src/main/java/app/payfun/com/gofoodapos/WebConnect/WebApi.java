...
//    public static final String SCHEMA = "" + SCHEMA + "";
    ...
    public static JSONObject regSelectIdConfirm(Context context, HashMap<String,String> sendData) throws Exception
    {


        String query = "SELECT COUNT(USER_ID) AS REG_ID_CHECK " +
    ...
    //전화번호 인증
    public static JSONObject regPhoneConfirm(Context context, HashMap<String, String> getOrderMap ) throws Exception
    {

        String query = "";
        //쿼리를 여기서 만든다.

        query =  "INSERT INTO " + SCHEMA + "OW_PUSH_INFO " +
                ...
                "(" +
                "'" +  getOrderMap.get("USER_PHONE_NUM") + "'" + "," +
                "'" +  getOrderMap.get("USER_CONFIRM_NUM") + "'" + "," +
                "'" +  getOrderMap.get("USER_PUSH_KEY") + "'" + "," +
                "NOW()" +
                ")" ;
