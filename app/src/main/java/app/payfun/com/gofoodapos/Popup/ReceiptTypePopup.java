...
public class ReceiptTypePopup extends Dialog implements View.OnClickListener {

	private String mBody2 = "";

	private OnEventOkListener mOnEventPopupListener;
	private OnEventCancelListener mOnEventCancelListener;
	private OnEventOtherListener mOnEventOtherListener;
	...
	public ReceiptTypePopup(Context context, String body2, OnEventOkListener onEventPopupListener, OnEventCancelListener onEventCancelListener, OnEventOtherListener onEventOtherListener) {
...
//		requestWindowFeature(Window.FEATURE_NO_TITLE);
		...
		bt_notice_confirm.setText("개인 현금영수증");
		bt_notice_cancel.setText("사업자 지출증빙");
		bt_notice_other.setText("가맹점 자진발급");
...
//				dismiss();
	...
	private void clickOther() {
		if (mOnEventOtherListener != null)
			mOnEventOtherListener.onOther();
