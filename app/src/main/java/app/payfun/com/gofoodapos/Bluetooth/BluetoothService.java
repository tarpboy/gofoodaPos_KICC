...
public class BluetoothService {
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        bundle.putString(Define.DEVICE_NAME, device.getName());
        msg.setData(bundle);
...
//        Bundle bundle = new Bundle();
//        bundle.putString(Define.TOAST, "Unable to connect device");
//        msg.setData(bundle);
//        mHandler.sendMessage(msg);
    }
...
//        Message msg = mHandler.obtainMessage(Define.MESSAGE_TOAST);
//        Bundle bundle = new Bundle();
//        bundle.putString(Define.TOAST, "Device connection was lost");
//        msg.setData(bundle);
//        mHandler.sendMessage(msg);
    }
            ...
            while (true) {
                try {
                    ...
                    if(bytes>0)
                    {
	                    ...
	                    mHandler.obtainMessage(Define.MESSAGE_READ, bytes, -1, buffer)
	                            .sendToTarget();
                    }
                    else
                    {
